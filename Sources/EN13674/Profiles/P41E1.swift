...
internal struct P41E1: RailProfile {
    ...
    internal static var profile = Path {
        ...
        Fillet(radius: 7)
        Arc(radius: 100.0, center: (-106, -138+48.5+30), .clockwise)
        Line(from: (-6, -138+48.5+30), to: (-6, -138+48.5))
        Arc(radius: 140.0, center: (-146, -138+48.5), .clockwise)
        Fillet(radius: 7.0)
        ...
        Fillet(radius: 6.0)
        Arc(radius: 140, center: (146, -138+48.5), .clockwise)
        Line(from: (6, -138+48.5), to: (6, -138 + 48.5+30))
        Arc(radius: 100, center: (106, -138+48.5+30), .clockwise)
        Fillet(radius: 7.0)
