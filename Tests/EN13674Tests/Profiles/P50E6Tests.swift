...
internal final class P50E6Tests: XCTestCase {

    let sut = P50E6.profile
    ...
    func testPathUpperLeft() {
        ...
        XCTAssertEqual((sut[7] as? LineElement)?.start.x, -7.75)
        XCTAssertEqual((sut[7] as? LineElement)?.end.x, -7.75)
    }
    ...
    func testPathLowerLeft() {
        ...
        XCTAssertEqual((sut[13] as? LineElement)?.start, (-70, -144.8), accuracy: 0.5)
        XCTAssertEqual((sut[13] as? LineElement)?.end, (-70, -151))

        XCTAssertEqual((sut[14] as? ArcElement)?.radius, 2, accuracy: defaultAccuracy)

        XCTAssertEqual((sut[15] as? LineElement)?.start, (-68, -153))
        XCTAssertEqual((sut[15] as? LineElement)?.end, (68, -153))
    }
    ...
    func testPathLowerRight() {
        ...
        XCTAssertEqual((sut[17] as? LineElement)?.start, (70, -151))
        XCTAssertEqual((sut[17] as? LineElement)?.end, (70, -144.8), accuracy: 0.5)
        ...
        XCTAssertEqual((sut[23] as? LineElement)?.start.x, 7.75)
        XCTAssertEqual((sut[23] as? LineElement)?.end.x, 7.75)
    }
