...
internal final class P54E1Tests: XCTestCase {

    let sut = P54E1.profile
    ...
    func testPathUpperLeft() {
        ...
        XCTAssertEqual((sut[0] as? ArcElement)?.endPoint?.x, -10.012, accuracy: defaultAccuracy)
    ...
    func testPathUpperRight() {
        ...
        XCTAssertEqual((sut[32] as? ArcElement)?.startPoint.x, 10.012, accuracy: defaultAccuracy)
    }
}
