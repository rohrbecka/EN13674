...
internal final class P49E2Tests: XCTestCase {

    let sut = P49E2.profile
    ...
    func testPathUpperLeft() {
        ...
        XCTAssertEqual((sut[6] as? ArcElement)?.center.y, -66, accuracy: defaultAccuracy)

        XCTAssertEqual((sut[7] as? LineElement)?.start, (-7, -66), accuracy: defaultAccuracy)
        XCTAssertEqual((sut[7] as? LineElement)?.end, (-7, -96), accuracy: defaultAccuracy)
    }
    ...
    func testPathLowerLeft() {
        ...
        XCTAssertEqual((sut[8] as? ArcElement)?.center.y, -96, accuracy: defaultAccuracy)
        ...
        XCTAssertEqual((sut[14] as? LineElement)?.start, (-62.5, -140.5), accuracy: 0.5)
        XCTAssertEqual((sut[14] as? LineElement)?.end, (-62.5, -146.5))

        XCTAssertEqual((sut[15] as? ArcElement)?.radius, 1.5, accuracy: defaultAccuracy)

        XCTAssertEqual((sut[16] as? LineElement)?.start, (-61, -148))
        XCTAssertEqual((sut[16] as? LineElement)?.end, (61, -148))
    }
    ...
    func testPathLowerRight() {
        ...
        XCTAssertEqual((sut[17] as? ArcElement)?.radius, 1.5, accuracy: defaultAccuracy)

        XCTAssertEqual((sut[18] as? LineElement)?.start, (62.5, -146.5))
        XCTAssertEqual((sut[18] as? LineElement)?.end, (62.5, -140.5), accuracy: 0.5)
        ...
        XCTAssertEqual((sut[24] as? ArcElement)?.center.y, -96)

        XCTAssertEqual((sut[25] as? LineElement)?.start, (7, -96), accuracy: defaultAccuracy)
        XCTAssertEqual((sut[25] as? LineElement)?.end, (7, -66), accuracy: defaultAccuracy)
    }
    ...
    func testPathUpperRight() {
        ...
        XCTAssertEqual((sut[26] as? ArcElement)?.center.y, -66)
