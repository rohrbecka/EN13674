...
internal final class P55E1Tests: XCTestCase {

    let sut = P55E1.profile
    ...
    func testPathUpperLeft() {
        ...
        XCTAssertEqual((sut[7] as? LineElement)?.start.x, -9.5)
        XCTAssertEqual((sut[7] as? LineElement)?.end.x, -9.5)
    }
    ...
    func testPathLowerLeft() {
        ...
        XCTAssertEqual((sut[10] as? ArcElement)?.radius, 23, accuracy: defaultAccuracy)
        ...
        XCTAssertEqual((sut[13] as? LineElement)?.start, (-67, -144), accuracy: 0.5)
        XCTAssertEqual((sut[13] as? LineElement)?.end, (-67, -153))

        XCTAssertEqual((sut[14] as? ArcElement)?.radius, 2, accuracy: defaultAccuracy)

        XCTAssertEqual((sut[15] as? LineElement)?.start, (-65, -155))
        XCTAssertEqual((sut[15] as? LineElement)?.end, (65, -155))
    }
    ...
    func testPathLowerRight() {
        ...
        XCTAssertEqual((sut[17] as? LineElement)?.start, (67, -153))
        XCTAssertEqual((sut[17] as? LineElement)?.end, (67, -144), accuracy: 0.5)
        ...
        XCTAssertEqual((sut[20] as? ArcElement)?.radius, 23, accuracy: defaultAccuracy)
        ...
        XCTAssertEqual((sut[23] as? LineElement)?.start.x, 9.5)
        XCTAssertEqual((sut[23] as? LineElement)?.end.x, 9.5)
    }
